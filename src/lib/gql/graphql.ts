...
export type ActiveOrderFragment = { __typename: 'Order', id: string, code: string, state: string, orderPlacedAt?: any | null, currencyCode: CurrencyCode, totalQuantity: number, subTotal: number, shipping: number, total: number, totalWithTax: number, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxBase: number, taxTotal: number }>, lines: Array<{ __typename?: 'OrderLine', id: string, unitPrice: number, unitPriceWithTax: number, quantity: number, linePrice: number, linePriceWithTax: number, productVariant: { __typename?: 'ProductVariant', id: string, name: string, sku: string, product: { __typename?: 'Product', slug: string } }, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null }>, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: number, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string, description: string } }>, discounts: Array<{ __typename?: 'Discount', description: string, amountWithTax: number }>, promotions: Array<{ __typename?: 'Promotion', id: string, startsAt?: any | null, endsAt?: any | null, couponCode?: string | null, perCustomerUsageLimit?: number | null, usageLimit?: number | null, name: string, description: string, enabled: boolean }>, surcharges: Array<{ __typename?: 'Surcharge', description: string, sku?: string | null, price: number, priceWithTax: number, taxRate: number }>, fulfillments?: Array<{ __typename?: 'Fulfillment', createdAt: any, updatedAt: any, state: string, method: string, trackingCode?: string | null, lines: Array<{ __typename?: 'FulfillmentLine', quantity: number, orderLine: { __typename?: 'OrderLine', id: string, productVariant: { __typename?: 'ProductVariant', id: string, name: string, sku: string } } }> }> | null } & { ' $fragmentName'?: 'ActiveOrderFragment' };
...
export type ProductFragment = { __typename?: 'Product', id: string, name: string, slug: string, description: string, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, variants: Array<{ __typename?: 'ProductVariant', id: string, price: number, stockLevel: string }>, customFields?: { __typename?: 'ProductCustomFields', shortDescription?: string | null } | null } & { ' $fragmentName'?: 'ProductFragment' };
